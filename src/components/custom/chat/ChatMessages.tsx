...
export default function ChatMessages({ messages, onSuggestionClick, isLoading }: ChatMessagesProps) {
  ...
  return (
    <div ref={scrollContainerRef} className="flex-1 overflow-y-auto" aria-live="polite" aria-relevant="additions">
      {messages.length === 0 ? (
